      ...
      $('#userSubmit').hide();
        ...
        $.ajax({
            ...
            success : function(response) {
                ...
                $('.pImg').append('<img src="/images/'+userEditData.pImg+'" width="100px" height="100px" margin: 40px padding: 40px; >');
            },
            error : function(err) {
                console.log(err);
            }
  ...
  $(document).on('click', '#userUpdate', function (form) {
                ...
                $.ajax({
                  ...
                  success: function(response){
                    ...
                    $("."+id).html('<td>'+userUpdateData.firstName+'</td><td>'+userUpdateData.lastName+'</td><td>'
